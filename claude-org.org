...
Blocks without CUSTOM_ID are not recorded."
  ...
  (let* ((custom-id (save-excursion
                      (goto-char (marker-position marker))
                      (claude-org--find-instruction-custom-id))))
      ...
      (save-restriction
        ...
        (condition-case nil
            (progn
              ...
              ;; Collect all parent headings (skip Workflow)
              (let ((headings (list (substring-no-properties (org-get-heading t t t t)))))
                (save-excursion
                  (while (org-up-heading-safe)
