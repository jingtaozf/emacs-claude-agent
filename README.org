...
Press =C-c C-/= to open the visual command menu:
...
|-----+---------+-------------|
| =C-c C-/= | Open menu | Show transient command menu |
...
When inserting new AI blocks in the Workflow section, use =C-c C-/= then =n= to select phase tags:
